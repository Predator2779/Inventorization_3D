...
namespace Inventory.Interaction
{
 public class InventoryServiceProvider : MonoBehaviour
 {
     ...
     {
         await InitializeGameStateProvider();
     ...
     private async UniTask InitializeGameStateProvider()
     {
         _gameStateProvider = new GameStatePlayerPrefsProvider();
         await _gameStateProvider.LoadGameState();
     }

     private void InitializeInventoryService()
     {
         _inventoriesService = new InventoriesService(_gameStateProvider);
     }
